...
class Shuffler:
    ...
    def save_data(self):
        ...
        :return: None
        """
        if 'verb_error_datasets_v1_0' not in os.listdir(os.getcwd()):
            os.mkdir('verb_error_datasets_v1_0')
        ...
        if identifier.split("_")[0] not in os.listdir('verb_error_datasets_v1_0'):
            os.mkdir(f'verb_error_datasets_v1_0/{identifier.split("_")[0]}')

        self.df_data.to_csv(f'verb_error_datasets_v1_0/{identifier.split("_")[0]}/{identifier}_{split}.tsv', sep='\t', encoding='utf-8', index_label='idx')
